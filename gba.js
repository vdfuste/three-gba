...
const gbaUrls = {
	frontCase: new URL("src/assets/case_front.glb", import.meta.url),
	backCase: new URL("src/assets/case_back.glb", import.meta.url),
	screen: new URL("src/assets/screen.glb", import.meta.url),
	buttonA: new URL("src/assets/button_a.glb", import.meta.url),
	buttonB: new URL("src/assets/button_b.glb", import.meta.url),
	buttonCross: new URL("src/assets/button_cross.glb", import.meta.url),
	buttonStart: new URL("src/assets/button_start.glb", import.meta.url),
	buttonSelect: new URL("src/assets/button_select.glb", import.meta.url),
};
